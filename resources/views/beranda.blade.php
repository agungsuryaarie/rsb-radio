            ...
            <div class="row align-items-stretch retro-layout">
                <div class="col-md-6">
                    <a href="single.html" class="h-entry img-5 h-100 gradient">
                        <div class="featured-img" style="background-image: url('{{ 'front-template/images/tour-1.jpg' }}');">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="post-entry-alt">
                        <a href="single.html" class="img-link"><img src="{{ 'front-template/images/img_7_horizontal.jpg' }}"
                        ...
                        <div class="excerpt">
                            ...
                            <div class="post-meta align-items-center text-left clearfix">
                                <figure class="author-figure mb-0 me-3 float-start"><img
                                        src="{{ 'front-template/images/person_1.jpg' }}" alt="Image" class="img-fluid">
                                </figure>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="post-entry-alt">
                        <a href="single.html" class="img-link"><img
                                src="{{ 'front-template/images/img_6_horizontal.jpg' }}" alt="Image"
                                class="img-fluid"></a>
                        <div class="excerpt">
                            ...
                            <div class="post-meta align-items-center text-left clearfix">
                                <figure class="author-figure mb-0 me-3 float-start"><img
                                        src="{{ 'front-template/images/person_2.jpg' }}" alt="Image"
                ...
                <div class="col-lg-4 mb-4">
                    <div class="post-entry-alt">
                        <a href="single.html" class="img-link"><img
                                src="{{ 'front-template/images/img_5_horizontal.jpg' }}" alt="Image"
                                class="img-fluid"></a>
                        <div class="excerpt">
                            ...
                            <div class="post-meta align-items-center text-left clearfix">
                                <figure class="author-figure mb-0 me-3 float-start"><img
                                        src="{{ 'front-template/images/person_3.jpg' }}" alt="Image"
                                        class="img-fluid"></figure>
                                <span class="d-inline-block mt-1">By <a href="#">David Anderson</a></span>
                                <span>&nbsp;-&nbsp; July 19, 2019</span>
                            </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="post-entry-alt">
                        <a href="single.html" class="img-link"><img
                                src="{{ 'front-template/images/img_4_horizontal.jpg' }}" alt="Image"
                                class="img-fluid"></a>
                        <div class="excerpt">
                            ...
                            <div class="post-meta align-items-center text-left clearfix">
                                <figure class="author-figure mb-0 me-3 float-start"><img
                                        src="{{ 'front-template/images/person_4.jpg' }}" alt="Image"
                                        class="img-fluid"></figure>
                                <span class="d-inline-block mt-1">By <a href="#">David Anderson</a></span>
                                <span>&nbsp;-&nbsp; July 19, 2019</span>
                            </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="post-entry-alt">
                        <a href="single.html" class="img-link"><img
                                src="{{ 'front-template/images/img_3_horizontal.jpg' }}" alt="Image"
                                class="img-fluid"></a>
                        <div class="excerpt">
                            ...
                            <div class="post-meta align-items-center text-left clearfix">
                                <figure class="author-figure mb-0 me-3 float-start"><img
                                        src="{{ 'front-template/images/person_5.jpg' }}" alt="Image"
                                        class="img-fluid"></figure>
                                <span class="d-inline-block mt-1">By <a href="#">David Anderson</a></span>
                                <span>&nbsp;-&nbsp; July 19, 2019</span>
                            </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="post-entry-alt">
                        <a href="single.html" class="img-link"><img
                                src="{{ 'front-template/images/img_2_horizontal.jpg' }}" alt="Image"
                                class="img-fluid"></a>
                        <div class="excerpt">
            ...
            <div class="row align-items-stretch retro-layout-alt">
                ...
                <div class="col-md-5 order-md-2">
                    <a href="single.html" class="hentry img-1 h-100 gradient">
                        <div class="featured-img"
                            style="background-image: url('{{ 'front-template/images/img_2_vertical.jpg' }}');"></div>
                        <div class="text">
                ...
                <div class="col-md-7">
                    ...
                    <a href="single.html" class="hentry img-2 v-height mb30 gradient">
                        <div class="featured-img"
                            style="background-image: url('{{ 'front-template/images/img_1_horizontal.jpg' }}');"></div>
                    ...
                    <div class="two-col d-block d-md-flex justify-content-between">
                        <a href="single.html" class="hentry v-height img-2 gradient">
                            <div class="featured-img"
                                style="background-image: url('{{ 'front-template/images/img_2_sq.jpg' }}');"></div>
                            <div class="text text-sm">
                                <span>February 12, 2019</span>
                                <h2>Don’t assume your user data in the cloud is safe</h2>
                            </div>
                        ...
                        <a href="single.html" class="hentry v-height img-2 ms-auto float-end gradient">
                            <div class="featured-img"
                                style="background-image: url('{{ 'front-template/images/img_3_sq.jpg' }}');"></div>
                            <div class="text text-sm">
                                <span>February 12, 2019</span>
                                <h2>Startup vs corporate: What job suits you best?</h2>
                            </div>
