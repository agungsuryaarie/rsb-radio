                    ...
                    <div class="post-content-body">
                        <div class="row my-4">
                            <div class="col-md-12 mb-4">
                                <img src="{{ 'front-template/images/tour-4.jpg' }}" alt="Image placeholder"
                    ...
                    <div class="sidebar-box">
                        ...
                        <div class="post-entry-sidebar">
                            <ul>
                                <li>
                                    <a href="">
                                        <img src="{{ 'front-template/images/tour-1.jpg' }}" alt="Image placeholder"
                                            class="me-4 rounded">
                                        <div class="text">
                                ...
                                <li>
                                    <a href="">
                                        <img src="{{ 'front-template/images/tour-2.jpg' }}" alt="Image placeholder"
                                            class="me-4 rounded">
                                        <div class="text">
                                            <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                            <div class="post-meta">
